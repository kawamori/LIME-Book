...
/************************************************************
 Internal functions
 ************************************************************/
/* NOTE: Exactly the same as listkey() in bulletin.js except launches
 *       hotnews.bml on code 19 instead of newsvod.bml.
...
//	debug_log( id + ":" + code);
	...
	if( code == 1) {
		...
		// Was data key press.
		romSound(7);
		gState.launchDocument( "../bml/hotnews.bml");
	}
...
/************************************************************/
/* NOTE: Exactly the same as listshow() in bulletin.js.
 * TODO: Generalise this function.
 */
function listShow() {
	for( var i = 0; i < 9; i++) {
...
/************************************************************/
/* NOTE: Exactly the same as setListFocus() in bulletin.js.
 * TODO: Generalise this function.
 */
