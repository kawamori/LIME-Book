...
gTimeArray[0] = new Array ("8.00 AM",800);
gTimeArray[1] = new Array ("8.30 AM",830);
gTimeArray[2] = new Array ("9.00 AM",900);
gTimeArray[3] = new Array ("9.30 AM",930);
gTimeArray[4] = new Array ("10.00 AM",1000);
gTimeArray[5] = new Array ("10.30 AM",1030);
gTimeArray[6] = new Array ("11.00 AM",1100);
gTimeArray[7] = new Array ("11.30 AM",1130);
gTimeArray[8] = new Array ("12.00 PM",1200);
gTimeArray[9] = new Array ("12.30 PM",1230);
gTimeArray[10] = new Array ("1.00 PM",1300);
gTimeArray[11] = new Array ("1.30 PM",1330);
gTimeArray[12] = new Array ("2.00 PM",1400);
gTimeArray[13] = new Array ("2.30 PM",1430);
gTimeArray[14] = new Array ("3.00 PM",1500);
gTimeArray[15] = new Array ("3.30 PM",1530);
gTimeArray[16] = new Array ("4.00 PM",1600);
gTimeArray[17] = new Array ("4.30 PM",1630);
gTimeArray[18] = new Array ("5.00 PM",1700);
gTimeArray[19] = new Array ("5.30 PM",1730);
gTimeArray[20] = new Array ("6.00 PM",1800);
gTimeArray[21] = new Array ("6.30 PM",1830);
gTimeArray[22] = new Array ("7.00 PM",1900);
gTimeArray[23] = new Array ("7.30 PM",1930);
gTimeArray[24] = new Array ("8.00 PM",2000);
gTimeArray[25] = new Array ("8.30 PM",2030);
gTimeArray[26] = new Array ("9.00 PM",2100);
gTimeArray[27] = new Array ("9.30 PM",2130);
gTimeArray[28] = new Array ("10.00 PM",2200);
gTimeArray[29] = new Array ("10.30 PM",2230);
...
var gURL1 = "http://live-pgw.iptvf.jp:12345/pgw/resolvecontent?contract_id=1234567890&purchase_id=1234567890&promo=on&crypt=no&drmid=100400000005ee98&cid=00fhcx0000";
var gURL2 = "http://live-pgw.iptvf.jp:12345/pgw/resolvecontent?contract_id=1234567890&purchase_id=1234567890&promo=on&crypt=no&drmid=100400000005ee98&cid=00fhcx0001";
var gURLPLAY ="";
//control widget menu
...
//				setText("debug2",gContentsArray[i][2]);
	...
	if (gTimeRecordArray[0]==gContentsArray[focus][0]){
		document.getElementById('ThumbPic').data = 
		'../images/'+gSnapshotArray[gPicInd];
	}

	document.getElementById('Syn1').firstChild.data = gContentsArray[focus][5];
	document.getElementById('Syn2').firstChild.data = gContentsArray[focus][6];
...
function clockStarts()
{
	...
	if( TimeNow != null) {
		clkText = padding( "00", TimeNow.getHours()) + ":"
				+ padding( "00", TimeNow.getMinutes())+" PM";
